...
<p><strong>(1) Report by selecting the  semester to enrole in  semester lots below then click the report button to submit details ,then <br />
(2)click on pay with tokens then enter  the tokens to make fee payment<br />
	(3) After Reporting click on fee statement button and print your fees statemnts easily</strong></p>
	</fieldset>

<form action="" method="Post" id="form3">
<fieldset><legend align="center">Report To New Semester</legend>
<table  align="center">
