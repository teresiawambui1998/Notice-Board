...
?>
	...
	<fieldset><legend align="center">Help</legend>(1) Report by selecting the  semester to enrole in  semester lots below then click the report button to submit details
	<p>(2)Choose to pay by Pesa Pay(PP) Or use of Tertiary Finance Card(TF_Card) then click pay button to make payment.</p> </fieldset>
...
<table  align="center">
  ...
  <tr>
    <td align="right">Report</td>
     <td bgcolor="#99CCFF"><label>Semesters<br />
 <select name="semester">
	<option>
	select semester	</option>
	
	<?php global $con;
$get_sem="select * from time_semester";
...
echo"<option>$sem</option>";
	...
	<button name="report" onclick='return report1()'>Report</button>
...
<tr> <td  id="hdtd"colspan="2" bgcolor="#99CCFF" >Pesa Pay(PP)</td></tr>
 <tr>
  ...
  <td width="50"><tr><td>Account</td>
    <td align="right"><input type="text" name="account" placeholder="your pesa pay account." required="required"></td>
     </tr>
	 <tr>
  <td width="50"><tr><td>Amount</td>
    <td align="right"><input type="text" name="amount" placeholder="enter amount." required="required"></td>
     </tr>
	  <tr>
...
<table  align="right">
 ...
 <tr> <td  id="hdtd"colspan="2" bgcolor="#99CCFF" >Tertiary Finance Card (TF_Card)</td></tr>
  <tr>
    <td align="right">Top_up_keys:</td>
    <td><Input type="text" name="topup" placeholder="Enter top_up keys."required="required"  /></td>
    </tr><tr>
